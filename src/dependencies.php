...
//            'searchUrlTemplate' => $searchUrlTemplate
    ...
    $container['httpClient'] = function (ContainerInterface $c) {
    ...
    $container['pcClient'] = function (ContainerInterface $c) {
    ...
    $container['psrCache'] = function (ContainerInterface $c) {
        $ttl = $c->get('settings')['cache']['ttl'];
    ...
    $container[CarsController::class] = function (ContainerInterface $c) {
        return new CarsController($c->get('renderer'), $c->get('pcClient'));
    };

    $container[CatalogsController::class] = function (ContainerInterface $c) {
        return new CatalogsController($c->get('renderer'), $c->get('pcClient'));
    };

    $container[GroupsController::class] = function (ContainerInterface $c) {
        return new GroupsController($c->get('renderer'), $c->get('pcClient'));
    };

    $container[ModelsController::class] = function (ContainerInterface $c) {
        return new ModelsController($c->get('renderer'), $c->get('pcClient'));
    };

    $container[PartsController::class] = function (ContainerInterface $c) {
